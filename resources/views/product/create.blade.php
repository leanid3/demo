<x-app-layout>
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data" class="car-form max-w-2xl mx-auto bg-white p-6 rounded-lg shadow-md">
            @csrf
            ...
            <div class="mb-6">
                ...
                <input type="text" name="model" id="model" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required>
